...
public class FlowFilterTwo implements Filter{
	String charset;
	public void init(FilterConfig config) {//FilterConfig객체는 <filter>태그에 설정한 정보를 추출할때 사용된다.
	...
	public void doFilter(ServletRequest req, ServletResponse res, FilterChain chain) throws java.io.IOException, ServletException{
		req.setCharacterEncoding(charset); //setCharacterEncoding은 post방식으로 전달되는 질의 문자열을 인코딩할때 쓰는 메소드
